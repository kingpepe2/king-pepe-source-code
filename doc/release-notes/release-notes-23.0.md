...
- Before this release, Kingpepe Core had a strong preference to try to connect only to peers that listen on port 24028. As a result of that, Kingpepe nodes listening on non-standard ports would likely not get any Kingpepe Core peers connecting to them. This preference has been removed. (#23542)
