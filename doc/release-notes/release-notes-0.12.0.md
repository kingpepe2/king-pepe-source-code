...
Then, to tunnel a SSL connection on 224027 to a RPC server bound on localhost on port 34027 do:

    stunnel -d 224027 -r 127.0.0.1:34027 -p stunnel.pem -P ''
...
caching. A sample config for apache2 could look like:
    ...
    <Location /kingpeperpc>
        ProxyPass http://127.0.0.1:24027/
        ProxyPassReverse http://127.0.0.1:24027/
