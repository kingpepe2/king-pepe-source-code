...
#ifndef KINGPEPE_INTERFACES_INIT_H
#define KINGPEPE_INTERFACES_INIT_H
...
//! (kingpepe-gui, kingpepe-node, kingpepe-wallet, kingpeped, kingpepe-qt) and each
...
#endif // KINGPEPE_INTERFACES_INIT_H
