...
#ifndef KINGPEPE_INTERFACES_NODE_H
#define KINGPEPE_INTERFACES_NODE_H
...
//! Top-level interface for a kingpepe node (kingpeped process).
class Node
{
public:
    virtual ~Node() {}
    ...
    //! Return setting value from <datadir>/settings.json or kingpepe.conf.
...
#endif // KINGPEPE_INTERFACES_NODE_H
