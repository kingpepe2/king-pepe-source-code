...
#ifndef KINGPEPE_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define KINGPEPE_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // KINGPEPE_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
