...
#ifndef KINGPEPE_WALLET_TRANSACTION_H
#define KINGPEPE_WALLET_TRANSACTION_H
...
public:
     ...
     * on this kingpepe node, and set to 0 for transactions that were created
...
#endif // KINGPEPE_WALLET_TRANSACTION_H
