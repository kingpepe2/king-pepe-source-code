...
#ifndef KINGPEPE_WALLET_WALLETUTIL_H
#define KINGPEPE_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! kingpepe from opening the wallet, thinking it was newly created, and
...
#endif // KINGPEPE_WALLET_WALLETUTIL_H
