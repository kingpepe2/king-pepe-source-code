...
BOOST_FIXTURE_TEST_CASE(handle_missing_inputs, TestChain100Setup)
{
    ...
    // mempool transaction.
    size_t coinbase_idx{1}; // Skip the KingPepe height-1 premine coinbase.
