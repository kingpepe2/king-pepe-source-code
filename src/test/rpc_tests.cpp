...
BOOST_AUTO_TEST_CASE(rpc_convert_values_generatetoaddress)
{
    ...
    BOOST_CHECK_NO_THROW(result = RPCConvertValues("generatetoaddress", {"101", "SqM6TEYxicgarLABNQhDnHwt7qxibpbsw9"}));
    BOOST_CHECK_EQUAL(result[0].getInt<int>(), 101);
    BOOST_CHECK_EQUAL(result[1].get_str(), "SqM6TEYxicgarLABNQhDnHwt7qxibpbsw9");

    BOOST_CHECK_NO_THROW(result = RPCConvertValues("generatetoaddress", {"101", "SnUFV82LrgBosAeQzriDLqXXnKubTMyNjj"}));
    BOOST_CHECK_EQUAL(result[0].getInt<int>(), 101);
    BOOST_CHECK_EQUAL(result[1].get_str(), "SnUFV82LrgBosAeQzriDLqXXnKubTMyNjj");

    BOOST_CHECK_NO_THROW(result = RPCConvertValues("generatetoaddress", {"1", "SqM6TEYxicgarLABNQhDnHwt7qxibpbsw9", "9"}));
    BOOST_CHECK_EQUAL(result[0].getInt<int>(), 1);
    BOOST_CHECK_EQUAL(result[1].get_str(), "SqM6TEYxicgarLABNQhDnHwt7qxibpbsw9");
    BOOST_CHECK_EQUAL(result[2].getInt<int>(), 9);

    BOOST_CHECK_NO_THROW(result = RPCConvertValues("generatetoaddress", {"1", "SnUFV82LrgBosAeQzriDLqXXnKubTMyNjj", "9"}));
    BOOST_CHECK_EQUAL(result[0].getInt<int>(), 1);
    BOOST_CHECK_EQUAL(result[1].get_str(), "SnUFV82LrgBosAeQzriDLqXXnKubTMyNjj");
    BOOST_CHECK_EQUAL(result[2].getInt<int>(), 9);
}
...
BOOST_AUTO_TEST_CASE(help_example)
{
    ...
    BOOST_CHECK_EQUAL(HelpExampleRpcNamed("test", args), "> curl --user myusername --data-binary '{\"jsonrpc\": \"2.0\", \"id\": \"curltest\", \"method\": \"test\", \"params\": {\"foo\":\"bar\",\"b\":true,\"n\":1}}' -H 'content-type: application/json' http://127.0.0.1:24027/\n");
    ...
    BOOST_CHECK_EQUAL(HelpExampleRpcNamed("test", {{"name", obj_value}}), "> curl --user myusername --data-binary '{\"jsonrpc\": \"2.0\", \"id\": \"curltest\", \"method\": \"test\", \"params\": {\"name\":{\"foo\":\"bar\",\"b\":false,\"n\":1}}}' -H 'content-type: application/json' http://127.0.0.1:24027/\n");
    ...
    BOOST_CHECK_EQUAL(HelpExampleRpcNamed("test", {{"name", arr_value}}), "> curl --user myusername --data-binary '{\"jsonrpc\": \"2.0\", \"id\": \"curltest\", \"method\": \"test\", \"params\": {\"name\":[\"bar\",false,1]}}' -H 'content-type: application/json' http://127.0.0.1:24027/\n");
