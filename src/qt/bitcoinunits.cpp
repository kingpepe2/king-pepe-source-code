...
{
    switch (unit) {
    case Unit::BTC: return QString("KPEPE");
    case Unit::mBTC: return QString("mKPEPE");
    case Unit::uBTC: return QString::fromUtf8("µBTC (bits)");
    case Unit::SAT: return QString("kpepey (sat)");
...
QString BitcoinUnits::shortName(Unit unit)
{
    ...
    case Unit::uBTC: return QString("uKPEPE");
...
{
    switch (unit) {
    case Unit::BTC: return QString("Kingpepe");
    case Unit::mBTC: return QString("Milli-Kingpepe (1 / 1" THIN_SP_UTF8 "000)");
    case Unit::uBTC: return QString("Micro-Kingpepe (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    case Unit::SAT: return QString("kpepey (sat) (1 / 100" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    } // no default case, so the compiler can warn about missing cases
    assert(false);
}
