...
public:
    ...
    /** Initialize with explicit network magic for protocol test vectors. */
    void Initialize(const EllSwiftPubKey& their_pubkey, bool initiator, bool self_decrypt, const MessageStartChars& message_start) noexcept;
