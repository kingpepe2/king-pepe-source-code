...
Options:
  -m, --multiprocess     Run multiprocess binaries kingpepe-node, kingpepe-gui.
  -M, --monolithic       Run monolithic binaries kingpeped, kingpepe-qt. (Default behavior)
  -v, --version          Show version information
  -h, --help             Show full help message

Commands:
  gui [ARGS]     Start GUI, equivalent to running 'kingpepe-qt [ARGS]' or 'kingpepe-gui [ARGS]'.
  node [ARGS]    Start node, equivalent to running 'kingpeped [ARGS]' or 'kingpepe-node [ARGS]'.
  rpc [ARGS]     Call RPC method, equivalent to running 'kingpepe-cli -named [ARGS]'.
  wallet [ARGS]  Call wallet command, equivalent to running 'kingpepe-wallet [ARGS]'.
  tx [ARGS]      Manipulate hex-encoded transactions, equivalent to running 'kingpepe-tx [ARGS]'.
...
Additional less commonly used commands:
  ...
  chainstate [ARGS] Run Kingpepe kernel chainstate util, equivalent to running 'kingpepe-chainstate [ARGS]'.
...
int main(int argc, char* argv[])
{
    ...
    try {
        ...
        if (cmd.show_help || cmd.command.empty()) {
            ...
            args.emplace_back(UseMultiprocess(cmd) ? "kingpepe-gui" : "kingpepe-qt");
        } else if (cmd.command == "node") {
            args.emplace_back(UseMultiprocess(cmd) ? "kingpepe-node" : "kingpeped");
        } else if (cmd.command == "rpc") {
            args.emplace_back("kingpepe-cli");
            // Since "kingpepe rpc" is a new interface that doesn't need to be
            ...
            args.emplace_back("kingpepe-util");
        } else {
...
//! Execute the specified kingpeped, kingpepe-qt or other command line in `args`
...
//!             be a relative path to a kingpeped, kingpepe-qt or other executable
