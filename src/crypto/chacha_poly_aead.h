...
#ifndef KINGPEPE_CRYPTO_CHACHA_POLY_AEAD_H
#define KINGPEPE_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@kingpepe.
 *
 ...
 *
 * The chacha20-poly1305@kingpepe combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@kingpepe cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@kingpepe are relatively fast in
...
#endif // KINGPEPE_CRYPTO_CHACHA_POLY_AEAD_H
