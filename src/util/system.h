 ...
 */
#ifndef KINGPEPE_UTIL_SYSTEM_H
#define KINGPEPE_UTIL_SYSTEM_H
...
extern const char * const KINGPEPE_CONF_FILENAME;
extern const char * const KINGPEPE_SETTINGS_FILENAME;
