...
def create_coinbase(height, pubkey=None, *, script_pubkey=None, extra_output_script=None, fees=0, nValue=3, halving_period=REGTEST_RETARGET_PERIOD):
    ...
    if nValue == 3:
        if height == 1:
            coinbaseoutput.nValue = 19740000 * COIN
        else:
