...
class NetTest(KingpepeTestFramework):
    ...
    def test_getnodeaddresses(self):
        ...
        self.nodes[0].addpeeraddress(address=ipv6_addr, port=24028)
        ...
        for i in range(10000):
            ...
            self.nodes[0].addpeeraddress(a, 24028)
    ...
    def test_addpeeraddress(self):
        ...
        assert_equal(node.addpeeraddress(address="", port=24028), {"success": False})
