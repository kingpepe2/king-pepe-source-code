...
class TxnMallTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # KingPepe's cached regtest wallets are intentionally asymmetric:
        # node0 owns the block-1 premine while the other nodes only have normal
        # matured rewards. Track each wallet from its own starting balance.
        ...
        # Create two spends using the reserved funding outputs.
        ...
        # Node0's balance should be starting balance, minus 40, minus 20, and
        # minus transaction fees. This test cache does not credit node0 with a
        # newly matured reward on the optional block.
        ...
        # Node0's total balance should be starting balance, minus 1240 for the
        # double-spend, plus fees (which are negative).
        ...
        assert_equal(self.nodes[1].getbalance(), node1_starting_balance + 1240)
