...
BLOCK_SUBSIDY = 3
TX_STATS_HEIGHT = COINBASE_MATURITY + 2
OP_RETURN_STATS_HEIGHT = TX_STATS_HEIGHT + 6
UNDERCLAIMED_STATS_HEIGHT = OP_RETURN_STATS_HEIGHT + 1
POST_COIN_STATS_HEIGHT = UNDERCLAIMED_STATS_HEIGHT + 1
REORGED_STATS_HEIGHT = POST_COIN_STATS_HEIGHT + 2
RECONSIDER_HEIGHT = COINBASE_MATURITY - 1
HASH_SERIALIZED_REJECT_HEIGHT = POST_COIN_STATS_HEIGHT + 1
...
class CoinStatsIndexTest(BitcoinTestFramework):
    ...
    def _test_coin_stats_index(self):
        ...
        for hash_option in index_hash_options:
            ...
            res2 = index_node.gettxoutsetinfo(hash_option, TX_STATS_HEIGHT)
            ...
            assert_raises_rpc_error(-8, "Querying specific block heights requires coinstatsindex", node.gettxoutsetinfo, hash_option, TX_STATS_HEIGHT)
        ...
        for hash_option in index_hash_options:
            ...
            assert_equal(res4['total_unspendable_amount'], BLOCK_SUBSIDY)
            assert_equal(res4['block_info'], {
                'unspendable': BLOCK_SUBSIDY,
                'prevout_spent': 0,
                'new_outputs_ex_coinbase': 0,
                'coinbase': 0,
                'unspendables': {
                    'genesis_block': BLOCK_SUBSIDY,
                    'bip30': 0,
                    'scripts': 0,
                    'unclaimed_rewards': 0
                }
            ...
            res5 = index_node.gettxoutsetinfo(hash_option, TX_STATS_HEIGHT)
            assert_equal(res5['total_unspendable_amount'], BLOCK_SUBSIDY)
            assert_equal(res5['block_info'], {
                'unspendable': Decimal('0E-8'),
                'prevout_spent': Decimal('19740000.00000000'),
                'new_outputs_ex_coinbase': Decimal('19739999.99968800'),
                'coinbase': Decimal('3.00031200'),
                'unspendables': {
        ...
        for hash_option in index_hash_options:
            ...
            res6 = index_node.gettxoutsetinfo(hash_option, OP_RETURN_STATS_HEIGHT)
            assert_equal(res6['total_unspendable_amount'], Decimal('23.99000000'))
            assert_equal(res6['block_info'], {
                'unspendable': Decimal('20.99000000'),
                'prevout_spent': Decimal('19740020.99968800'),
                'new_outputs_ex_coinbase': Decimal('19739999.99967800'),
                'coinbase': Decimal('3.01001000'),
                'unspendables': {
                    'genesis_block': Decimal('0E-8'),
                    'bip30': Decimal('0E-8'),
        ...
        # has two outputs
        cb = create_coinbase(UNDERCLAIMED_STATS_HEIGHT, nValue=2)
        cb.vout.append(CTxOut(int(Decimal('0.5') * COIN), CScript([OP_FALSE])))
        ...
        for hash_option in index_hash_options:
            res7 = index_node.gettxoutsetinfo(hash_option, UNDERCLAIMED_STATS_HEIGHT)
            assert_equal(res7['total_unspendable_amount'], Decimal('24.49000000'))
            assert_equal(res7['block_info'], {
                'unspendable': Decimal('0.50000000'),
                'prevout_spent': Decimal('0E-8'),
                'new_outputs_ex_coinbase': Decimal('0E-8'),
                'coinbase': Decimal('2.50000000'),
                'unspendables': {
                    'genesis_block': Decimal('0E-8'),
                    'bip30': Decimal('0E-8'),
                    'scripts': Decimal('0E-8'),
                    'unclaimed_rewards': Decimal('0.50000000')
                }
            })
    ...
    def _test_use_index_option(self):
        ...
        self.nodes[0].waitforblockheight(POST_COIN_STATS_HEIGHT)
    ...
    def _test_reorg_index(self):
        ...
        assert_equal(index_node.gettxoutsetinfo('muhash')['height'], POST_COIN_STATS_HEIGHT)
        ...
        res2 = index_node.gettxoutsetinfo(hash_type='muhash', hash_or_height=REORGED_STATS_HEIGHT)
        ...
        block = index_node.getblockhash(RECONSIDER_HEIGHT)
        index_node.invalidateblock(block)
        index_node.reconsiderblock(block)
        res3 = index_node.gettxoutsetinfo(hash_type='muhash', hash_or_height=REORGED_STATS_HEIGHT)
    ...
    def _test_index_rejects_hash_serialized(self):
        ...
        assert_raises_rpc_error(-8, msg, self.nodes[1].gettxoutsetinfo, hash_type='hash_serialized_3', hash_or_height=HASH_SERIALIZED_REJECT_HEIGHT)

        for use_index in {True, False, None}:
            assert_raises_rpc_error(-8, msg, self.nodes[1].gettxoutsetinfo, hash_type='hash_serialized_3', hash_or_height=HASH_SERIALIZED_REJECT_HEIGHT, use_index=use_index)
