...
# The KingPepe height-1 premine matures after COINBASE_MATURITY blocks. After
# mining COINBASE_MATURITY + 1 blocks, only the premine is mature.
BLOCKS = COINBASE_MATURITY + 1
BALANCE = Decimal('19740000')
NEXT_MATURE_SUBSIDY = Decimal('3')
...
WALLET_NOT_SPECIFIED = (
    ...
    "option before the command (run \"kingpepe-cli -h\" for help or \"kingpepe-cli listwallets\" to see "
...
class TestBitcoinCli(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        if self.is_wallet_compiled():
            ...
            amounts = [BALANCE - Decimal('40.000072') + NEXT_MATURE_SUBSIDY, Decimal(9), Decimal(31)]
            ...
            # Mine a block to confirm; height 2's 3 KPEPE reward matures for the default wallet.
