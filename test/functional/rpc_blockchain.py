...
class BlockchainTest(BitcoinTestFramework):
    ...
    def _test_verificationprogress(self):
        self.log.info("Check that verificationprogress remains capped at 1 with KingPepe zero chainTxData")
        future = 2 * 60 * 60
        ...
        self.log.info("Check that verificationprogress stays at 1 after a new header with KingPepe zero chainTxData")
    ...
    def _test_gettxoutsetinfo(self):
        ...
        assert_equal(res['total_amount'], Decimal('19740520.50000000'))
    ...
    def _test_gettxout(self):
        ...
        assert_equal(txout['value'], Decimal('1.50000000'))
