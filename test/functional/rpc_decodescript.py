...
class DecodeScriptTest(BitcoinTestFramework):
    ...
    def decodescript_script_pub_key(self):
        ...
        assert_equal('rkpepe1pfees2mf9l9', rpc_result['address'])
    ...
    def decodescript_miniscript(self):
        ...
        assert res["segwit"]["desc"] == "addr(rkpepe1q73qyfypp47hvgnkjqnav0j3k2lq3v76wg22dk8tmwuz5sfgv66xs25nkrv)#3g0s5zl5"
