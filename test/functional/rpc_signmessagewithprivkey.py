...
class SignMessagesWithPrivTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        priv_key = 'VGNm8BbQBqchErGkQWKe4jz5Cu396kehHQudY5SrWEonyL9d9dhs'
        expected_signature = 'H3NYxeUFIyd94SYx73avbdu9ekLVfQZZrlmhKGdeSLv6J7Q8nUnRIItWC3yDm6BVYfmFqTTqwMfpDg9cAo0uDf8='
        ...
        assert_equal(addresses[0], 'T8RuskxKPvqPzwDSsNmTKc3f8oubdqWt2B')
        ...
        assert_raises_rpc_error(-3, "Malformed base64 encoding", self.nodes[0].verifymessage, 'T8RuskxKPvqPzwDSsNmTKc3f8oubdqWt2B', "invalid_sig", message)
