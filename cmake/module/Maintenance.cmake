...
function(add_windows_deploy_target)
  if(MINGW AND TARGET kingpepe AND TARGET kingpepe-qt AND TARGET kingpeped AND TARGET kingpepe-cli AND TARGET kingpepe-tx AND TARGET kingpepe-wallet AND TARGET kingpepe-util AND TARGET test_kingpepe)
    ...
    generate_setup_nsi()
    add_custom_command(
      OUTPUT ${PROJECT_BINARY_DIR}/kingpepe-win64-setup.exe
      COMMAND ${CMAKE_COMMAND} -E make_directory ${PROJECT_BINARY_DIR}/release
      COMMAND ${CMAKE_STRIP} $<TARGET_FILE:kingpepe> -o ${PROJECT_BINARY_DIR}/release/$<TARGET_FILE_NAME:kingpepe>
      COMMAND ${CMAKE_STRIP} $<TARGET_FILE:kingpepe-qt> -o ${PROJECT_BINARY_DIR}/release/$<TARGET_FILE_NAME:kingpepe-qt>
      COMMAND ${CMAKE_STRIP} $<TARGET_FILE:kingpeped> -o ${PROJECT_BINARY_DIR}/release/$<TARGET_FILE_NAME:kingpeped>
      COMMAND ${CMAKE_STRIP} $<TARGET_FILE:kingpepe-cli> -o ${PROJECT_BINARY_DIR}/release/$<TARGET_FILE_NAME:kingpepe-cli>
    ...
    add_custom_target(deploy DEPENDS ${PROJECT_BINARY_DIR}/kingpepe-win64-setup.exe)
  endif()
endfunction()

function(add_macos_deploy_target)
  if(CMAKE_SYSTEM_NAME STREQUAL "Darwin" AND TARGET kingpepe-qt)
    set(macos_app "Kingpepe-Qt.app")
    # Populate Contents subdirectory.
    configure_file(${PROJECT_SOURCE_DIR}/share/qt/Info.plist.in ${macos_app}/Contents/Info.plist NO_SOURCE_PERMISSIONS)
    file(CONFIGURE OUTPUT ${macos_app}/Contents/PkgInfo CONTENT "APPL????")
    # Populate Contents/Resources subdirectory.
    file(CONFIGURE OUTPUT ${macos_app}/Contents/Resources/empty.lproj CONTENT "")
    configure_file(${PROJECT_SOURCE_DIR}/src/qt/res/icons/kingpepe.icns ${macos_app}/Contents/Resources/kingpepe.icns NO_SOURCE_PERMISSIONS COPYONLY)
    file(CONFIGURE OUTPUT ${macos_app}/Contents/Resources/Base.lproj/InfoPlist.strings
      CONTENT "{ CFBundleDisplayName = \"@CLIENT_NAME@\"; CFBundleName = \"@CLIENT_NAME@\"; }"
    )

    add_custom_command(
      OUTPUT ${PROJECT_BINARY_DIR}/${macos_app}/Contents/MacOS/Kingpepe-Qt
      COMMAND ${CMAKE_COMMAND} --install ${PROJECT_BINARY_DIR} --config $<CONFIG> --component kingpepe-qt --prefix ${macos_app}/Contents/MacOS --strip
      COMMAND ${CMAKE_COMMAND} -E rename ${macos_app}/Contents/MacOS/bin/$<TARGET_FILE_NAME:kingpepe-qt> ${macos_app}/Contents/MacOS/Kingpepe-Qt
      COMMAND ${CMAKE_COMMAND} -E rm -rf ${macos_app}/Contents/MacOS/bin
      COMMAND ${CMAKE_COMMAND} -E rm -rf ${macos_app}/Contents/MacOS/share
      VERBATIM
    )

    set(macos_zip "kingpepe-macos-app")
    if(CMAKE_HOST_APPLE)
      add_custom_command(
        ...
        DEPENDS ${PROJECT_BINARY_DIR}/${macos_app}/Contents/MacOS/Kingpepe-Qt
        VERBATIM
      )
      ...
      add_custom_command(
        OUTPUT ${PROJECT_BINARY_DIR}/dist/${macos_app}/Contents/MacOS/Kingpepe-Qt
      ...
      add_custom_target(deploydir
        DEPENDS ${PROJECT_BINARY_DIR}/dist/${macos_app}/Contents/MacOS/Kingpepe-Qt
      )
    ...
    add_dependencies(deploydir kingpepe-qt)
