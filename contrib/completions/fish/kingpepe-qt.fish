...
complete --command kingpepe-qt --no-files

# Extract options
function __fish_kingpepeqt_get_options
...
complete \
    --command kingpepe-qt \
    --arguments "(__fish_kingpepeqt_get_options --nofiles)"
