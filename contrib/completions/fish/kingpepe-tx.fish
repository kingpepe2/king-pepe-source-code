...
# Extract options
function __fish_kingpepe_tx_get_options
...
# Extract commands
function __fish_kingpepe_tx_get_commands
...
complete \
    --command kingpepe-tx \
    --condition "not __fish_kingpepe_seen_cmd (__fish_kingpepe_tx_get_commands --commandsonly)" \
    --arguments "(__fish_kingpepe_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command kingpepe-tx \
    --arguments "(__fish_kingpepe_tx_get_commands)" \
    --no-files
