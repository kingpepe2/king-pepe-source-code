...
complete --command kingpeped --no-files

# Extract options
function __fish_kingpeped_get_options
...
complete \
    --command kingpeped \
    --arguments "(__fish_kingpeped_get_options --nofiles)"
