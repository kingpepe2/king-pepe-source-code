...
BITCOIND=${BITCOIND:-$BINDIR/kingpeped}
...
then
  ...
  echo -e "To safely generate a kingpepe.conf file, please commit your changes to $BITCOIND, rebuild, then run this script again.\n"
fi
