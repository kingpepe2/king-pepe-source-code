...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef KINGPEPE_CHAINPARAMSSEEDS_H\n')
    g.write('#define KINGPEPE_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the kingpepe network\n')
    ...
    g.write('#endif // KINGPEPE_CHAINPARAMSSEEDS_H\n')
