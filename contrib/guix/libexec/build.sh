...
(
    ...
    case "$HOST" in
        *mingw*)
            ...
            mv build/kingpepe-win64-setup.exe "${OUTDIR}/${DISTNAME}-win64-setup-unsigned.exe"
            ;;
    esac
    ...
    (
        ...
        # copy over the example kingpepe.conf file. if contrib/devtools/gen-bitcoin-conf.sh
    ...
    case "$HOST" in
        ...
        *darwin*)
            ...
            mv build/dist/kingpepe-macos-app.zip "${OUTDIR}/${DISTNAME}-${HOST}-unsigned.zip"
