...
The input UTXO set can be generated by Kingpepe Core with the `dumptxoutset` RPC:
$ kingpepe-cli dumptxoutset ~/utxos.dat latest
...
UTXO_DUMP_VERSION = 2
NET_MAGIC_BYTES = {
    b"\xf3\xea\xce\x21": "Mainnet",
    b"\x0f\x1b\xf2\xe1": "Signet",
    b"\x40\x7a\x52\xef": "Testnet",
    b"\xfe\x30\x25\x64": "Regtest",
}
